use winapi::shared::minwindef::{ATOM, HMODULE, HINSTANCE, ULONG, LPDWORD, PUINT, LPARAM, PBYTE, LPWORD, WORD, INT, DWORD, WPARAM, LPBYTE, LPINT, BOOL, HRGN, LRESULT, UINT, BYTE, HKL, HWINSTA, LPVOID, PULONG};
use winapi::shared::windef::{DPI_HOSTING_BEHAVIOR, HCURSOR, HDC, HHOOK, DPI_AWARENESS_CONTEXT, HMENU, HICON, POINT, HBITMAP, RECT, LPRECT, DPI_AWARENESS, SIZE, HDESK, HWINEVENTHOOK, LPPOINT, HACCEL, HBRUSH, HMONITOR, COLORREF, LPCRECT, HWND};
use winapi::shared::basetsd::{INT_PTR, UINT_PTR, UINT32, PUINT_PTR, ULONG_PTR, PDWORD_PTR, LONG_PTR};
use winapi::shared::ntdef::{LPSTR, HANDLE, VOID, LPCSTR, LONG, SHORT, WCHAR, LPWSTR, PVOID, LPCWSTR, CHAR};
use winapi::shared::guiddef::{LPCGUID};
use winapi::ctypes::{c_int, c_long, c_uint};
use winapi::um::winuser::{LPCDLGTEMPLATEA, SCROLLINFO, WNDCLASSW, POINTER_TOUCH_INFO, LPWNDCLASSA, PALTTABINFO, WNDCLASSEXA, TOUCH_HIT_TESTING_PROXIMITY_EVALUATION, MENUTEMPLATEA, HTOUCHINPUT, LPWNDCLASSEXA, UPDATELAYEREDWINDOWINFO, MSGBOXPARAMSA, WNDENUMPROC, LPMONITORINFO, GRAYSTRINGPROC, PAINTSTRUCT, HDWP, PFLASHWINFO, POINTER_FEEDBACK_MODE, LPWNDCLASSEXW, LPINPUT, HSYNTHETICPOINTERDEVICE, DESKTOPENUMPROCW, MENUTEMPLATEW, LPTRACKMOUSEEVENT, LPCDLGTEMPLATEW, DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS, WINEVENTPROC, MSGBOXPARAMSW, PCRAWINPUTDEVICE, WNDCLASSEXW, PROPENUMPROCA, PWINDOWINFO, FEEDBACK_TYPE, HDEVNOTIFY, PCURSORINFO, PCOMBOBOXINFO, LPCMENUINFO, PSCROLLBARINFO, TOUCH_HIT_TESTING_INPUT, LPPAINTSTRUCT, LPMOUSEMOVEPOINT, POINTER_INPUT_TYPE, LPACCEL, WNDPROC, PRAWINPUTDEVICELIST, WINDOWPLACEMENT, LPMSG, DIALOG_DPI_CHANGE_BEHAVIORS, SENDASYNCPROC, HOOKPROC, PGUITHREADINFO, INPUT_TRANSFORM, HPOWERNOTIFY, PTITLEBARINFO, PICONINFO, LPDRAWTEXTPARAMS, PRAWINPUTDEVICE, PROPENUMPROCW, WINSTAENUMPROCW, POINTER_INFO, PBSMINFO, MONITORENUMPROC, POINTER_PEN_INFO, LPCMENUITEMINFOW, WNDCLASSA, PTOUCHINPUT, LPMENUITEMINFOA, TIMERPROC, LPMENUITEMINFOW, LPMENUINFO, LPWNDCLASSW, PRAWINPUT, HRAWINPUT, MSG, DESKTOPENUMPROCA, PCHANGEFILTERSTRUCT, WINSTAENUMPROCA, DRAWSTATEPROC, PLASTINPUTINFO, LPTPMPARAMS, POINTER_TYPE_INFO, LPCMENUITEMINFOA, DLGPROC, PMENUBARINFO};
use winapi::um::wingdi::{PDISPLAY_DEVICEW, DEVMODEW, PDISPLAY_DEVICEA, BLENDFUNCTION, DEVMODEA};
use winapi::um::winnt::{ACCESS_MASK, PSECURITY_INFORMATION, PSECURITY_DESCRIPTOR};
...
pub type FnAdjustWindowRectExForDpi = unsafe extern "system" fn(LPRECT, DWORD, BOOL, DWORD, UINT) -> BOOL;
...
pub type FnAreDpiAwarenessContextsEqual = unsafe extern "system" fn(DPI_AWARENESS_CONTEXT, DPI_AWARENESS_CONTEXT) -> BOOL;
...
pub type FnBroadcastSystemMessageA = unsafe extern "system" fn(DWORD, LPDWORD, UINT, WPARAM, LPARAM) -> LONG;
pub type FnBroadcastSystemMessageExA = unsafe extern "system" fn(DWORD, LPDWORD, UINT, WPARAM, LPARAM, PBSMINFO) -> c_long;
pub type FnBroadcastSystemMessageExW = unsafe extern "system" fn(DWORD, LPDWORD, UINT, WPARAM, LPARAM, PBSMINFO) -> c_long;
pub type FnBroadcastSystemMessageW = unsafe extern "system" fn(DWORD, LPDWORD, UINT, WPARAM, LPARAM) -> LONG;
pub type FnCalculatePopupWindowPosition = unsafe extern "system" fn(*const POINT, *const SIZE, UINT, *mut RECT, *mut RECT) -> BOOL;
...
pub type FnCallWindowProcA = unsafe extern "system" fn(WNDPROC, HWND, UINT, WPARAM, LPARAM) -> LRESULT;
pub type FnCallWindowProcW = unsafe extern "system" fn(WNDPROC, HWND, UINT, WPARAM, LPARAM) -> LRESULT;
pub type FnCancelShutdown = unsafe extern "system" fn() -> BOOL;
pub type FnCascadeWindows = unsafe extern "system" fn(HWND, UINT, *const RECT, UINT, *const HWND) -> WORD;
...
pub type FnChangeDisplaySettingsExA = unsafe extern "system" fn(LPCSTR, *mut DEVMODEA, HWND, DWORD, LPVOID) -> LONG;
pub type FnChangeDisplaySettingsExW = unsafe extern "system" fn(LPCWSTR, *mut DEVMODEW, HWND, DWORD, LPVOID) -> LONG;
...
pub type FnChangeWindowMessageFilterEx = unsafe extern "system" fn(HWND, UINT, DWORD, PCHANGEFILTERSTRUCT) -> BOOL;
...
pub type FnCreateCursor = unsafe extern "system" fn(HINSTANCE, c_int, c_int, c_int, c_int, *const VOID, *const VOID) -> HCURSOR;
pub type FnCreateDesktopA = unsafe extern "system" fn(LPCSTR, LPCSTR, *mut DEVMODEA, DWORD, ACCESS_MASK, LPSECURITY_ATTRIBUTES) -> HDESK;
pub type FnCreateDesktopExA = unsafe extern "system" fn(LPCSTR, LPCSTR, *mut DEVMODEA, DWORD, ACCESS_MASK, LPSECURITY_ATTRIBUTES, ULONG, PVOID) -> HDESK;
pub type FnCreateDesktopExW = unsafe extern "system" fn(LPCWSTR, LPCWSTR, *mut DEVMODEW, DWORD, ACCESS_MASK, LPSECURITY_ATTRIBUTES, ULONG, PVOID) -> HDESK;
pub type FnCreateDesktopW = unsafe extern "system" fn(LPCWSTR, LPCWSTR, *mut DEVMODEW, DWORD, ACCESS_MASK, LPSECURITY_ATTRIBUTES) -> HDESK;
pub type FnCreateDialogIndirectParamA = unsafe extern "system" fn(HINSTANCE, LPCDLGTEMPLATEA, HWND, DLGPROC, LPARAM) -> HWND;
pub type FnCreateDialogIndirectParamW = unsafe extern "system" fn(HINSTANCE, LPCDLGTEMPLATEW, HWND, DLGPROC, LPARAM) -> HWND;
pub type FnCreateDialogParamA = unsafe extern "system" fn(HINSTANCE, LPCSTR, HWND, DLGPROC, LPARAM) -> HWND;
pub type FnCreateDialogParamW = unsafe extern "system" fn(HINSTANCE, LPCWSTR, HWND, DLGPROC, LPARAM) -> HWND;
pub type FnCreateIcon = unsafe extern "system" fn(HINSTANCE, c_int, c_int, BYTE, BYTE, *const BYTE, *const BYTE) -> HICON;
pub type FnCreateIconFromResource = unsafe extern "system" fn(PBYTE, DWORD, BOOL, DWORD) -> HICON;
pub type FnCreateIconFromResourceEx = unsafe extern "system" fn(PBYTE, DWORD, BOOL, DWORD, c_int, c_int, UINT) -> HICON;
pub type FnCreateIconIndirect = unsafe extern "system" fn(PICONINFO) -> HICON;
pub type FnCreateMDIWindowA = unsafe extern "system" fn(LPCSTR, LPCSTR, DWORD, c_int, c_int, c_int, c_int, HWND, HINSTANCE, LPARAM) -> HWND;
pub type FnCreateMDIWindowW = unsafe extern "system" fn(LPCWSTR, LPCWSTR, DWORD, c_int, c_int, c_int, c_int, HWND, HINSTANCE, LPARAM) -> HWND;
pub type FnCreateMenu = unsafe extern "system" fn() -> HMENU;
pub type FnCreatePopupMenu = unsafe extern "system" fn() -> HMENU;
pub type FnCreateSyntheticPointerDevice = unsafe extern "system" fn(POINTER_INPUT_TYPE, ULONG, POINTER_FEEDBACK_MODE) -> HSYNTHETICPOINTERDEVICE;
pub type FnCreateWindowExA = unsafe extern "system" fn(DWORD, LPCSTR, LPCSTR, DWORD, c_int, c_int, c_int, c_int, HWND, HMENU, HINSTANCE, LPVOID) -> HWND;
pub type FnCreateWindowExW = unsafe extern "system" fn(DWORD, LPCWSTR, LPCWSTR, DWORD, c_int, c_int, c_int, c_int, HWND, HMENU, HINSTANCE, LPVOID) -> HWND;
pub type FnCreateWindowStationA = unsafe extern "system" fn(LPCSTR, DWORD, ACCESS_MASK, LPSECURITY_ATTRIBUTES) -> HWINSTA;
pub type FnCreateWindowStationW = unsafe extern "system" fn(LPCWSTR, DWORD, ACCESS_MASK, LPSECURITY_ATTRIBUTES) -> HWINSTA;
...
pub type FnDeferWindowPos = unsafe extern "system" fn(HDWP, HWND, HWND, c_int, c_int, c_int, c_int, UINT) -> HDWP;
...
pub type FnDialogBoxIndirectParamA = unsafe extern "system" fn(HINSTANCE, LPCDLGTEMPLATEA, HWND, DLGPROC, LPARAM) -> INT_PTR;
pub type FnDialogBoxIndirectParamW = unsafe extern "system" fn(HINSTANCE, LPCDLGTEMPLATEW, HWND, DLGPROC, LPARAM) -> INT_PTR;
pub type FnDialogBoxParamA = unsafe extern "system" fn(HINSTANCE, LPCSTR, HWND, DLGPROC, LPARAM) -> INT_PTR;
pub type FnDialogBoxParamW = unsafe extern "system" fn(HINSTANCE, LPCWSTR, HWND, DLGPROC, LPARAM) -> INT_PTR;
...
pub type FnDlgDirListComboBoxA = unsafe extern "system" fn(HWND, LPSTR, c_int, c_int, UINT) -> c_int;
pub type FnDlgDirListComboBoxW = unsafe extern "system" fn(HWND, LPWSTR, c_int, c_int, UINT) -> c_int;
...
pub type FnDrawAnimatedRects = unsafe extern "system" fn(HWND, c_int, *const RECT, *const RECT) -> BOOL;
...
pub type FnDrawIconEx = unsafe extern "system" fn(HDC, c_int, c_int, HICON, c_int, c_int, UINT, HBRUSH, UINT) -> BOOL;
pub type FnDrawMenuBar = unsafe extern "system" fn(HWND) -> BOOL;
pub type FnDrawStateA = unsafe extern "system" fn(HDC, HBRUSH, DRAWSTATEPROC, LPARAM, WPARAM, c_int, c_int, c_int, c_int, UINT) -> BOOL;
pub type FnDrawStateW = unsafe extern "system" fn(HDC, HBRUSH, DRAWSTATEPROC, LPARAM, WPARAM, c_int, c_int, c_int, c_int, UINT) -> BOOL;
pub type FnDrawTextA = unsafe extern "system" fn(HDC, LPCSTR, c_int, LPRECT, UINT) -> c_int;
pub type FnDrawTextExA = unsafe extern "system" fn(HDC, LPCSTR, c_int, LPRECT, UINT, LPDRAWTEXTPARAMS) -> c_int;
pub type FnDrawTextExW = unsafe extern "system" fn(HDC, LPCWSTR, c_int, LPRECT, UINT, LPDRAWTEXTPARAMS) -> c_int;
...
pub type FnEnumDisplayDevicesA = unsafe extern "system" fn(LPCSTR, DWORD, PDISPLAY_DEVICEA, DWORD) -> BOOL;
pub type FnEnumDisplayDevicesW = unsafe extern "system" fn(LPCWSTR, DWORD, PDISPLAY_DEVICEW, DWORD) -> BOOL;
pub type FnEnumDisplayMonitors = unsafe extern "system" fn(HDC, LPCRECT, MONITORENUMPROC, LPARAM) -> BOOL;
pub type FnEnumDisplaySettingsA = unsafe extern "system" fn(LPCSTR, DWORD, *mut DEVMODEA) -> BOOL;
pub type FnEnumDisplaySettingsExA = unsafe extern "system" fn(LPCSTR, DWORD, *mut DEVMODEA, DWORD) -> BOOL;
pub type FnEnumDisplaySettingsExW = unsafe extern "system" fn(LPCWSTR, DWORD, *mut DEVMODEW, DWORD) -> BOOL;
...
pub type FnEvaluateProximityToPolygon = unsafe extern "system" fn(UINT32, *const POINT, *const TOUCH_HIT_TESTING_INPUT, *mut TOUCH_HIT_TESTING_PROXIMITY_EVALUATION) -> BOOL;
pub type FnEvaluateProximityToRect = unsafe extern "system" fn(*const RECT, *const TOUCH_HIT_TESTING_INPUT, *mut TOUCH_HIT_TESTING_PROXIMITY_EVALUATION) -> BOOL;
...
pub type FnGetAltTabInfoA = unsafe extern "system" fn(HWND, c_int, PALTTABINFO, LPSTR, UINT) -> BOOL;
pub type FnGetAltTabInfoW = unsafe extern "system" fn(HWND, c_int, PALTTABINFO, LPWSTR, UINT) -> BOOL;
...
pub type FnGetAwarenessFromDpiAwarenessContext = unsafe extern "system" fn(DPI_AWARENESS_CONTEXT) -> DPI_AWARENESS;
...
pub type FnGetDialogControlDpiChangeBehavior = unsafe extern "system" fn(HWND) -> DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS;
pub type FnGetDialogDpiChangeBehavior = unsafe extern "system" fn(HWND) -> DIALOG_DPI_CHANGE_BEHAVIORS;
...
pub type FnGetLayeredWindowAttributes = unsafe extern "system" fn(HWND, *mut COLORREF, *mut BYTE, *mut DWORD) -> BOOL;
...
pub type FnGetMouseMovePointsEx = unsafe extern "system" fn(UINT, LPMOUSEMOVEPOINT, LPMOUSEMOVEPOINT, c_int, DWORD) -> c_int;
...
pub type FnGetPointerFrameInfo = unsafe extern "system" fn(UINT32, *mut UINT32, *mut POINTER_INFO) -> BOOL;
pub type FnGetPointerFrameInfoHistory = unsafe extern "system" fn(UINT32, *mut UINT32, *mut UINT32, *mut POINTER_INFO) -> BOOL;
pub type FnGetPointerFramePenInfo = unsafe extern "system" fn(UINT32, *mut UINT32, *mut POINTER_PEN_INFO) -> BOOL;
pub type FnGetPointerFramePenInfoHistory = unsafe extern "system" fn(UINT32, *mut UINT32, *mut UINT32, *mut POINTER_PEN_INFO) -> BOOL;
pub type FnGetPointerFrameTouchInfo = unsafe extern "system" fn(UINT32, *mut UINT32, *mut POINTER_TOUCH_INFO) -> BOOL;
pub type FnGetPointerFrameTouchInfoHistory = unsafe extern "system" fn(UINT32, *mut UINT32, *mut UINT32, *mut POINTER_TOUCH_INFO) -> BOOL;
pub type FnGetPointerInfo = unsafe extern "system" fn(UINT32, *mut POINTER_INFO) -> BOOL;
pub type FnGetPointerInfoHistory = unsafe extern "system" fn(UINT32, *mut UINT32, *mut POINTER_INFO) -> BOOL;
pub type FnGetPointerInputTransform = unsafe extern "system" fn(UINT32, UINT32, *mut INPUT_TRANSFORM) -> BOOL;
pub type FnGetPointerPenInfo = unsafe extern "system" fn(UINT32, *mut POINTER_PEN_INFO) -> BOOL;
pub type FnGetPointerPenInfoHistory = unsafe extern "system" fn(UINT32, *mut UINT32, *mut POINTER_PEN_INFO) -> BOOL;
pub type FnGetPointerTouchInfo = unsafe extern "system" fn(UINT32, *mut POINTER_TOUCH_INFO) -> BOOL;
pub type FnGetPointerTouchInfoHistory = unsafe extern "system" fn(UINT32, *mut UINT32, *mut POINTER_TOUCH_INFO) -> BOOL;
...
pub type FnGetRawInputData = unsafe extern "system" fn(HRAWINPUT, UINT, LPVOID, PUINT, UINT) -> UINT;
...
pub type FnGetRawInputDeviceList = unsafe extern "system" fn(PRAWINPUTDEVICELIST, PUINT, UINT) -> UINT;
pub type FnGetRegisteredRawInputDevices = unsafe extern "system" fn(PRAWINPUTDEVICE, PUINT, UINT) -> UINT;
...
pub type FnGetTabbedTextExtentA = unsafe extern "system" fn(HDC, LPCSTR, c_int, c_int, *const INT) -> DWORD;
pub type FnGetTabbedTextExtentW = unsafe extern "system" fn(HDC, LPCWSTR, c_int, c_int, *const INT) -> DWORD;
...
pub type FnGetTouchInputInfo = unsafe extern "system" fn(HTOUCHINPUT, c_uint, PTOUCHINPUT, c_int) -> BOOL;
...
pub type FnGetUserObjectInformationA = unsafe extern "system" fn(HANDLE, c_int, PVOID, DWORD, LPDWORD) -> BOOL;
pub type FnGetUserObjectInformationW = unsafe extern "system" fn(HANDLE, c_int, PVOID, DWORD, LPDWORD) -> BOOL;
pub type FnGetUserObjectSecurity = unsafe extern "system" fn(HANDLE, PSECURITY_INFORMATION, PSECURITY_DESCRIPTOR, DWORD, LPDWORD) -> BOOL;
...
pub type FnGetWindowFeedbackSetting = unsafe extern "system" fn(HWND, FEEDBACK_TYPE, DWORD, *mut UINT32, *mut VOID) -> BOOL;
...
pub type FnGrayStringA = unsafe extern "system" fn(HDC, HBRUSH, GRAYSTRINGPROC, LPARAM, c_int, c_int, c_int, c_int, c_int) -> BOOL;
pub type FnGrayStringW = unsafe extern "system" fn(HDC, HBRUSH, GRAYSTRINGPROC, LPARAM, c_int, c_int, c_int, c_int, c_int) -> BOOL;
...
pub type FnInjectSyntheticPointerInput = unsafe extern "system" fn(HSYNTHETICPOINTERDEVICE, *const POINTER_TYPE_INFO, UINT32) -> BOOL;
...
pub type FnLoadImageA = unsafe extern "system" fn(HINSTANCE, LPCSTR, UINT, c_int, c_int, UINT) -> HANDLE;
pub type FnLoadImageW = unsafe extern "system" fn(HINSTANCE, LPCWSTR, UINT, c_int, c_int, UINT) -> HANDLE;
...
pub type FnLogicalToPhysicalPointForPerMonitorDPI = unsafe extern "system" fn(HWND, LPPOINT) -> BOOL;
pub type FnLookupIconIdFromDirectory = unsafe extern "system" fn(PBYTE, BOOL) -> c_int;
pub type FnLookupIconIdFromDirectoryEx = unsafe extern "system" fn(PBYTE, BOOL, c_int, c_int, UINT) -> c_int;
...
pub type FnMsgWaitForMultipleObjects = unsafe extern "system" fn(DWORD, *const HANDLE, BOOL, DWORD, DWORD) -> DWORD;
pub type FnMsgWaitForMultipleObjectsEx = unsafe extern "system" fn(DWORD, *const HANDLE, DWORD, DWORD, DWORD) -> DWORD;
...
pub type FnPackTouchHitTestingProximityEvaluation = unsafe extern "system" fn(*const TOUCH_HIT_TESTING_INPUT, *const TOUCH_HIT_TESTING_PROXIMITY_EVALUATION) -> LRESULT;
...
pub type FnPhysicalToLogicalPointForPerMonitorDPI = unsafe extern "system" fn(HWND, LPPOINT) -> BOOL;
...
pub type FnRegisterDeviceNotificationA = unsafe extern "system" fn(HANDLE, LPVOID, DWORD) -> HDEVNOTIFY;
pub type FnRegisterDeviceNotificationW = unsafe extern "system" fn(HANDLE, LPVOID, DWORD) -> HDEVNOTIFY;
...
pub type FnRegisterPointerInputTargetEx = unsafe extern "system" fn(HWND, POINTER_INPUT_TYPE, BOOL) -> BOOL;
pub type FnRegisterPowerSettingNotification = unsafe extern "system" fn(HANDLE, LPCGUID, DWORD) -> HPOWERNOTIFY;
pub type FnRegisterRawInputDevices = unsafe extern "system" fn(PCRAWINPUTDEVICE, UINT, UINT) -> BOOL;
pub type FnRegisterShellHookWindow = unsafe extern "system" fn(HWND) -> BOOL;
pub type FnRegisterSuspendResumeNotification = unsafe extern "system" fn(HANDLE, DWORD) -> HPOWERNOTIFY;
...
pub type FnScrollDC = unsafe extern "system" fn(HDC, c_int, c_int, *const RECT, *const RECT, HRGN, LPRECT) -> BOOL;
pub type FnScrollWindow = unsafe extern "system" fn(HWND, c_int, c_int, *const RECT, *const RECT) -> BOOL;
pub type FnScrollWindowEx = unsafe extern "system" fn(HWND, c_int, c_int, *const RECT, *const RECT, HRGN, LPRECT, UINT) -> c_int;
pub type FnSendDlgItemMessageA = unsafe extern "system" fn(HWND, c_int, UINT, WPARAM, LPARAM) -> LRESULT;
pub type FnSendDlgItemMessageW = unsafe extern "system" fn(HWND, c_int, UINT, WPARAM, LPARAM) -> LRESULT;
...
pub type FnSendMessageCallbackA = unsafe extern "system" fn(HWND, UINT, WPARAM, LPARAM, SENDASYNCPROC, ULONG_PTR) -> BOOL;
pub type FnSendMessageCallbackW = unsafe extern "system" fn(HWND, UINT, WPARAM, LPARAM, SENDASYNCPROC, ULONG_PTR) -> BOOL;
pub type FnSendMessageTimeoutA = unsafe extern "system" fn(HWND, UINT, WPARAM, LPARAM, UINT, UINT, PDWORD_PTR) -> LRESULT;
pub type FnSendMessageTimeoutW = unsafe extern "system" fn(HWND, UINT, WPARAM, LPARAM, UINT, UINT, PDWORD_PTR) -> LRESULT;
...
pub type FnSetCoalescableTimer = unsafe extern "system" fn(HWND, UINT_PTR, UINT, TIMERPROC, ULONG) -> UINT_PTR;
...
pub type FnSetDialogControlDpiChangeBehavior = unsafe extern "system" fn(HWND, DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS, DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS) -> BOOL;
pub type FnSetDialogDpiChangeBehavior = unsafe extern "system" fn(HWND, DIALOG_DPI_CHANGE_BEHAVIORS, DIALOG_DPI_CHANGE_BEHAVIORS) -> BOOL;
...
pub type FnSetLayeredWindowAttributes = unsafe extern "system" fn(HWND, COLORREF, BYTE, DWORD) -> BOOL;
...
pub type FnSetMenuItemBitmaps = unsafe extern "system" fn(HMENU, UINT, UINT, HBITMAP, HBITMAP) -> BOOL;
pub type FnSetMenuItemInfoA = unsafe extern "system" fn(HMENU, UINT, BOOL, LPCMENUITEMINFOA) -> BOOL;
pub type FnSetMenuItemInfoW = unsafe extern "system" fn(HMENU, UINT, BOOL, LPCMENUITEMINFOW) -> BOOL;
...
pub type FnSetThreadDpiAwarenessContext = unsafe extern "system" fn(DPI_AWARENESS_CONTEXT) -> DPI_AWARENESS_CONTEXT;
pub type FnSetThreadDpiHostingBehavior = unsafe extern "system" fn(DPI_HOSTING_BEHAVIOR) -> DPI_HOSTING_BEHAVIOR;
pub type FnSetTimer = unsafe extern "system" fn(HWND, UINT_PTR, UINT, TIMERPROC) -> UINT_PTR;
pub type FnSetUserObjectInformationA = unsafe extern "system" fn(HANDLE, c_int, PVOID, DWORD) -> BOOL;
pub type FnSetUserObjectInformationW = unsafe extern "system" fn(HANDLE, c_int, PVOID, DWORD) -> BOOL;
pub type FnSetUserObjectSecurity = unsafe extern "system" fn(HANDLE, PSECURITY_INFORMATION, PSECURITY_DESCRIPTOR) -> BOOL;
pub type FnSetWinEventHook = unsafe extern "system" fn(DWORD, DWORD, HMODULE, WINEVENTPROC, DWORD, DWORD, DWORD) -> HWINEVENTHOOK;
...
pub type FnSetWindowFeedbackSetting = unsafe extern "system" fn(HWND, FEEDBACK_TYPE, DWORD, UINT32, *const VOID) -> BOOL;
...
pub type FnSetWindowPos = unsafe extern "system" fn(HWND, HWND, c_int, c_int, c_int, c_int, UINT) -> BOOL;
...
pub type FnSetWindowsHookExA = unsafe extern "system" fn(c_int, HOOKPROC, HINSTANCE, DWORD) -> HHOOK;
pub type FnSetWindowsHookExW = unsafe extern "system" fn(c_int, HOOKPROC, HINSTANCE, DWORD) -> HHOOK;
...
pub type FnSystemParametersInfoForDpi = unsafe extern "system" fn(UINT, UINT, PVOID, UINT, UINT) -> BOOL;
pub type FnSystemParametersInfoW = unsafe extern "system" fn(UINT, UINT, PVOID, UINT) -> BOOL;
pub type FnTabbedTextOutA = unsafe extern "system" fn(HDC, c_int, c_int, LPCSTR, c_int, c_int, *const INT, c_int) -> LONG;
pub type FnTabbedTextOutW = unsafe extern "system" fn(HDC, c_int, c_int, LPCWSTR, c_int, c_int, *const INT, c_int) -> LONG;
pub type FnToAscii = unsafe extern "system" fn(UINT, UINT, *const BYTE, LPWORD, UINT) -> c_int;
pub type FnToAsciiEx = unsafe extern "system" fn(UINT, UINT, *const BYTE, LPWORD, UINT, HKL) -> c_int;
pub type FnToUnicode = unsafe extern "system" fn(UINT, UINT, *const BYTE, LPWSTR, c_int, UINT) -> c_int;
pub type FnToUnicodeEx = unsafe extern "system" fn(UINT, UINT, *const BYTE, LPWSTR, c_int, UINT, HKL) -> c_int;
pub type FnTrackMouseEvent = unsafe extern "system" fn(LPTRACKMOUSEEVENT) -> BOOL;
pub type FnTrackPopupMenu = unsafe extern "system" fn(HMENU, UINT, c_int, c_int, c_int, HWND, *const RECT) -> BOOL;
pub type FnTrackPopupMenuEx = unsafe extern "system" fn(HMENU, UINT, INT, INT, HWND, LPTPMPARAMS) -> BOOL;
...
pub type FnUnregisterPointerInputTarget = unsafe extern "system" fn(HWND, POINTER_INPUT_TYPE) -> BOOL;
pub type FnUnregisterPointerInputTargetEx = unsafe extern "system" fn(HWND, POINTER_INPUT_TYPE) -> BOOL;
...
pub type FnUpdateLayeredWindow = unsafe extern "system" fn(HWND, HDC, *mut POINT, *mut SIZE, HDC, *mut POINT, COLORREF, *mut BLENDFUNCTION, DWORD) -> BOOL;
pub type FnUpdateLayeredWindowIndirect = unsafe extern "system" fn(HWND, *mut UPDATELAYEREDWINDOWINFO) -> BOOL;
