use winapi::um::winnt::{AUDIT_EVENT_TYPE, LPOSVERSIONINFOA, TOKEN_INFORMATION_CLASS, PEXCEPTION_RECORD, PLUID_AND_ATTRIBUTES, PSYSTEM_PROCESSOR_CYCLE_TIME_INFORMATION, PFLS_CALLBACK_FUNCTION, PTOKEN_PRIVILEGES, PTP_TIMER_CALLBACK, PACL, PTP_CLEANUP_GROUP, PWOW64_CONTEXT, PGENERIC_MAPPING, EXCEPTION_POINTERS, PTP_TIMER, PCONTEXT, CONTEXT, WOW64_CONTEXT, PSECURITY_DESCRIPTOR_CONTROL, WAITORTIMERCALLBACK, PTP_WAIT_CALLBACK, PSID_IDENTIFIER_AUTHORITY, PSLIST_HEADER, FILE_SEGMENT_ELEMENT, PTP_WORK, WELL_KNOWN_SID_TYPE, PCLAIM_SECURITY_ATTRIBUTES_INFORMATION, SECURITY_DESCRIPTOR_CONTROL, PSID, PTP_POOL_STACK_INFORMATION, PTP_POOL, TOKEN_TYPE, ACL_INFORMATION_CLASS, PPRIVILEGE_SET, HEAP_INFORMATION_CLASS, PAPCFUNC, PTP_SIMPLE_CALLBACK, PSYSTEM_LOGICAL_PROCESSOR_INFORMATION, PTP_IO, PTP_CALLBACK_ENVIRON, PSLIST_ENTRY, LPOSVERSIONINFOW, PTP_WORK_CALLBACK, SECURITY_IMPERSONATION_LEVEL, POBJECT_TYPE_LIST, PTOKEN_GROUPS, PTP_WAIT, LOGICAL_PROCESSOR_RELATIONSHIP, PROCESS_MITIGATION_POLICY, PSID_AND_ATTRIBUTES, SECURITY_INFORMATION, PTP_CALLBACK_INSTANCE, PVECTORED_EXCEPTION_HANDLER, PMEMORY_BASIC_INFORMATION, PSECURITY_DESCRIPTOR};
...
use winapi::um::minwinbase::{LPCONTEXT, GET_FILEEX_INFO_LEVELS, LPSECURITY_ATTRIBUTES, PREASON_CONTEXT, LPWIN32_FIND_DATAW, PSECURITY_ATTRIBUTES, SECURITY_ATTRIBUTES, LPENCLAVE_ROUTINE, LPCRITICAL_SECTION, LPTHREAD_START_ROUTINE, SYSTEMTIME, LPWIN32_FIND_DATAA, FILE_INFO_BY_HANDLE_CLASS, LPOVERLAPPED, FINDEX_SEARCH_OPS, LPSYSTEMTIME, FINDEX_INFO_LEVELS, LPOVERLAPPED_ENTRY, LPDEBUG_EVENT, LPOVERLAPPED_COMPLETION_ROUTINE, LPPROCESS_HEAP_ENTRY, PCRITICAL_SECTION};
use winapi::um::winbase::{LPCOMSTAT, LPDCB, LPFILE_ID_DESCRIPTOR, PACTCTX_SECTION_KEYED_DATA, LPCOMMCONFIG, COPYFILE2_EXTENDED_PARAMETERS, LPCOMMPROP, LPCOMMTIMEOUTS, LPFIBER_START_ROUTINE, APPLICATION_RECOVERY_CALLBACK, PCACTCTXW, LPPROGRESS_ROUTINE};
...
use winapi::um::winnls::{LCTYPE, CODEPAGE_ENUMPROCW, LPNLSVERSIONINFO, DATEFMT_ENUMPROCEXEX, TIMEFMT_ENUMPROCEX, LPCPINFO, CALINFO_ENUMPROCEXW, UILANGUAGE_ENUMPROCW, CALID, DATEFMT_ENUMPROCW, DATEFMT_ENUMPROCEXW, PFILEMUIINFO, LOCALE_ENUMPROCEX, NLS_FUNCTION, LANGGROUPLOCALE_ENUMPROCW, LPCPINFOEXW, GEOTYPE, LGRPID, GEOID, LPNLSVERSIONINFOEX, CALTYPE, NUMBERFMTW, TIMEFMT_ENUMPROCW, LANGUAGEGROUP_ENUMPROCW, CALINFO_ENUMPROCEXEX, CALINFO_ENUMPROCW, NORM_FORM, GEO_ENUMPROC, CURRENCYFMTW, LOCALE_ENUMPROCW, LOCALE_ENUMPROCA, GEOCLASS};
...
use winapi::um::perflib::{PPERF_COUNTERSET_INFO, PPERF_PROVIDER_CONTEXT, PERFLIBREQUEST, PPERF_COUNTERSET_INSTANCE};
...
use winapi::shared::ntdef::{PCNZCH, PCZZWSTR, PLONG, ULONGLONG, LONG, LPSTR, HRESULT, PLUID, HANDLE, LONGLONG, LCID, GROUP_AFFINITY, PCNZWCH, PVOID, VOID, PULARGE_INTEGER, PULONGLONG, LPCWCH, LPWSTR, LPCH, PPROCESSOR_NUMBER, CHAR, PZZWSTR, WCHAR, PWSTR, LPCSTR, PHANDLE, LARGE_INTEGER, LPCWSTR, PCWSTR, LPWCH, PLARGE_INTEGER, LANGID, PGROUP_AFFINITY, BOOLEAN};
use winapi::shared::minwindef::{PUSHORT, INT, LPBOOL, LPHANDLE, PHKEY, LPCVOID, PUINT, BOOL, LPLONG, UINT, PDWORD, LPBYTE, HINSTANCE, LPFILETIME, LPINT, HGLOBAL, BYTE, LPDWORD, FARPROC, HLOCAL, DWORD, PFILETIME, FILETIME, LPVOID, USHORT, PUCHAR, ULONG, LPARAM, UCHAR, LPWORD, PBOOL, HRSRC, HMODULE, PULONG, WORD, HKEY};
use winapi::shared::basetsd::{ULONG64, LONG_PTR, ULONG_PTR, PULONG_PTR, PSIZE_T, SIZE_T, DWORD_PTR, PULONG64};
use winapi::shared::guiddef::{GUID, LPCGUID, LPGUID};
use winapi::shared::evntprov::{PREGHANDLE, PEVENT_DATA_DESCRIPTOR, PCEVENT_DESCRIPTOR, REGHANDLE, EVENT_INFO_CLASS, PENABLECALLBACK};
use winapi::shared::windef::{HWND};
use winapi::shared::evntrace::{PTRACE_GUID_REGISTRATION, PTRACEHANDLE, WMIDPREQUEST, PEVENT_TRACE_HEADER, TRACEHANDLE};
...
pub type FnCallEnclave = unsafe extern "system" fn(LPENCLAVE_ROUTINE, LPVOID, BOOL, *mut LPVOID) -> BOOL;
...
pub type FnDeriveCapabilitySidsFromName = unsafe extern "system" fn(LPCWSTR, *mut DWORD, *mut DWORD) -> BOOL;
...
pub type FnEnumProcessModules = unsafe extern "system" fn(HANDLE, *mut HMODULE, DWORD, LPDWORD) -> BOOL;
pub type FnEnumProcessModulesEx = unsafe extern "system" fn(HANDLE, *mut HMODULE, DWORD, LPDWORD, DWORD) -> BOOL;
...
pub type FnGetFileVersionInfoA = unsafe extern "system" fn(LPCSTR, DWORD, DWORD, *mut c_void) -> BOOL;
...
pub type FnGetFileVersionInfoW = unsafe extern "system" fn(LPCWSTR, DWORD, DWORD, *mut c_void) -> BOOL;
...
pub type FnGetModuleFileNameExW = unsafe extern "system" fn(HANDLE, HMODULE, LPWSTR, DWORD) -> DWORD;
...
pub type FnGetModuleInformation = unsafe extern "system" fn(HANDLE, HMODULE, LPMODULEINFO, DWORD) -> BOOL;
...
pub type FnGetProcessMemoryInfo = unsafe extern "system" fn(HANDLE, PPROCESS_MEMORY_COUNTERS, DWORD) -> BOOL;
...
pub type FnGetWsChanges = unsafe extern "system" fn(HANDLE, PPSAPI_WS_WATCH_INFORMATION, DWORD) -> BOOL;
pub type FnGetWsChangesEx = unsafe extern "system" fn(HANDLE, PPSAPI_WS_WATCH_INFORMATION_EX, PDWORD) -> BOOL;
...
pub type FnInternetTimeFromSystemTimeA = unsafe extern "system" fn(*const SYSTEMTIME, DWORD, LPSTR, DWORD) -> BOOL;
pub type FnInternetTimeFromSystemTimeW = unsafe extern "system" fn(*const SYSTEMTIME, DWORD, LPWSTR, DWORD) -> BOOL;
pub type FnInternetTimeToSystemTimeA = unsafe extern "system" fn(LPCSTR, *mut SYSTEMTIME, DWORD) -> BOOL;
pub type FnInternetTimeToSystemTimeW = unsafe extern "system" fn(LPCWSTR, *mut SYSTEMTIME, DWORD) -> BOOL;
